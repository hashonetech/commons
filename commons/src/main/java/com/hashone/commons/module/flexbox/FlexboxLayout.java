...
public class FlexboxLayout extends ViewGroup implements FlexContainer {
        ...
        if (mAlignItems == AlignItems.BASELINE) {
            for (FlexLine flexLine : mFlexLines) {
                ...
                for (int i = 0; i < flexLine.getItemCount(); i++) {
                    int viewIndex = flexLine.getFirstIndex() + i;
                    ...
                    if (mFlexWrap != FlexWrap.WRAP_REVERSE) {
                        int marginTop = flexLine.getMMaxBaseline() - child.getBaseline();
                        marginTop = Math.max(marginTop, lp.topMargin);
                        largestHeightInLine = Math.max(largestHeightInLine,
                                child.getMeasuredHeight() + marginTop + lp.bottomMargin);
                    } else {
                        int marginBottom = flexLine.getMMaxBaseline() - child.getMeasuredHeight() +
                                child.getBaseline();
                ...
                flexLine.setCrossSize(largestHeightInLine);
            }
        }
        ...
        for (int i = 0, size = mFlexLines.size(); i < size; i++) {
            ...
            switch (mJustifyContent) {
                ...
                case JustifyContent.FLEX_END:
                    childLeft = width - flexLine.getMainSize() + paddingRight;
                    childRight = flexLine.getMainSize() - paddingLeft;
                    break;
                case JustifyContent.CENTER:
                    childLeft = paddingLeft + (width - flexLine.getMainSize()) / 2f;
                    childRight = width - paddingRight - (width - flexLine.getMainSize()) / 2f;
                    break;
                case JustifyContent.SPACE_AROUND: {
                    int visibleCount = flexLine.getItemCountNotGone();
                    if (visibleCount != 0) {
                        spaceBetweenItem = (width - flexLine.getMainSize())
                                / (float) visibleCount;
                    }
                ...
                case JustifyContent.SPACE_BETWEEN: {
                    ...
                    spaceBetweenItem = (width - flexLine.getMainSize()) / denominator;
                    childRight = width - paddingRight;
                    break;
                }
            ...
            for (int j = 0; j < flexLine.getItemCount(); j++) {
                int index = flexLine.getFirstIndex() + j;
                ...
                if (j == flexLine.getItemCount() - 1 && (mShowDividerVertical & SHOW_DIVIDER_END) > 0) {
            ...
            childTop += flexLine.getCrossSize();
            childBottom -= flexLine.getCrossSize();
        }
    }
        ...
        for (int i = 0, size = mFlexLines.size(); i < size; i++) {
            ...
            switch (mJustifyContent) {
                case JustifyContent.FLEX_START:
                    ...
                    break;
                case JustifyContent.FLEX_END:
                    childTop = height - flexLine.getMainSize() + paddingBottom;
                    childBottom = flexLine.getMainSize() - paddingTop;
                    break;
                case JustifyContent.CENTER:
                    childTop = paddingTop + (height - flexLine.getMainSize()) / 2f;
                    childBottom = height - paddingBottom - (height - flexLine.getMainSize()) / 2f;
                    break;
                case JustifyContent.SPACE_AROUND: {
                    int visibleCount = flexLine.getItemCountNotGone();
                    if (visibleCount != 0) {
                        spaceBetweenItem = (height - flexLine.getMainSize())
                                / (float) visibleCount;
                    }
                ...
                case JustifyContent.SPACE_BETWEEN: {
                    ...
                    int visibleCount = flexLine.getItemCountNotGone();
                    float denominator = visibleCount != 1 ? visibleCount - 1 : 1f;
                    spaceBetweenItem = (height - flexLine.getMainSize()) / denominator;
                    childBottom = height - paddingBottom;
                    break;
                }
                case JustifyContent.SPACE_EVENLY: {
            ...
            childLeft += flexLine.getCrossSize();
            childRight -= flexLine.getCrossSize();
        }
    }
    ...
    private void drawDividersHorizontal(Canvas canvas, boolean isRtl, boolean fromBottomToTop) {
        ...
        for (int i = 0, size = mFlexLines.size(); i < size; i++) {
            FlexLine flexLine = mFlexLines.get(i);
            for (int j = 0; j < flexLine.getItemCount(); j++) {
                int viewIndex = flexLine.getFirstIndex() + j;
                ...
                if (hasDividerBeforeChildAtAlongMainAxis(viewIndex, j)) {
                    ...
                    drawVerticalDivider(canvas, dividerLeft, flexLine.getMTop(), flexLine.getCrossSize());
                }
                ...
                if (j == flexLine.getItemCount() - 1) {
                    if ((mShowDividerVertical & SHOW_DIVIDER_END) > 0) {
                        ...
                        drawVerticalDivider(canvas, dividerLeft, flexLine.getMTop(),
                                flexLine.getCrossSize());
                    }
                }
            }
            ...
            if (hasDividerBeforeFlexLine(i)) {
                ...
                if (fromBottomToTop) {
                    horizontalDividerTop = flexLine.getMBottom();
                } else {
                    horizontalDividerTop = flexLine.getMTop() - mDividerHorizontalHeight;
                }
        ...
        for (int i = 0, size = mFlexLines.size(); i < size; i++) {
            ...
            for (int j = 0; j < flexLine.getItemCount(); j++) {
                ...
                if (hasDividerBeforeChildAtAlongMainAxis(viewIndex, j)) {
                    ...
                    drawHorizontalDivider(canvas, flexLine.getMLeft(), dividerTop, flexLine.getCrossSize());
                }
                ...
                if (j == flexLine.getItemCount() - 1) {
                    if ((mShowDividerHorizontal & SHOW_DIVIDER_END) > 0) {
                        ...
                        drawHorizontalDivider(canvas, flexLine.getMLeft(), dividerTop,
                                flexLine.getCrossSize());
                    }
                }
            }
            ...
            if (hasDividerBeforeFlexLine(i)) {
                ...
                if (isRtl) {
                    verticalDividerLeft = flexLine.getMRight();
                } else {
                    verticalDividerLeft = flexLine.getMLeft() - mDividerVerticalWidth;
                }
    ...
    public void onNewFlexLineAdded(FlexLine flexLine) {
        ...
        if (isMainAxisDirectionHorizontal()) {
            if ((mShowDividerVertical & SHOW_DIVIDER_END) > 0) {
                flexLine.setMainSize(flexLine.getMainSize() + mDividerVerticalWidth);
                flexLine.setMDividerLengthInMainSize(flexLine.getMDividerLengthInMainSize() + mDividerVerticalWidth);
            }
        } else {
            if ((mShowDividerHorizontal & SHOW_DIVIDER_END) > 0) {
                flexLine.setMainSize(flexLine.getMainSize() + mDividerHorizontalHeight);
                flexLine.setMDividerLengthInMainSize(flexLine.getMDividerLengthInMainSize() + mDividerHorizontalHeight);
            }
        }
    }
    ...
    @Override
    public void setFlexLines(@NonNull ArrayList<FlexLine> flexLines) {
